...
### 文件: src\core\pixelizer\config.rs
```rust
#[derive(Debug, Clone)]
...
### 文件: src\core\pixelizer\downsample.rs
```rust
use crate::core::color::Color;
use std::collections::HashMap;
...
### 文件: src\core\pixelizer\edge_selout.rs
```rust
use crate::core::color::Color;
...
### 文件: src\core\pixelizer\pipeline.rs
```rust
use crate::core::color::Color;
...
### 文件: src\core\pixelizer\quantize.rs
```rust
use crate::core::color::Color;
